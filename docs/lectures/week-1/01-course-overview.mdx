...
**TMI:** This course website is built with [Docusaurus](https://docusaurus.io/) (a React-based static site generator) and MDX for content. The source code is available on [GitHub](https://github.com/thartka/uva-ai-in-healthcare).

<img 
  src="/img/AI-in-healthcare-stack.png" 
  alt="Tech stack: Cursor IDE → Docusaurus → GitHub → Cloudflare" 
  style={{
    width: '100%',
    maxWidth: '800px',
    height: 'auto',
