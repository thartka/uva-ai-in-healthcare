...
3. **Explain how CNNs work** — Describe how CNNs process images through convolutional filters, weight sharing, pooling, and hierarchical feature learning.

4. **Understand why interpretability matters** — Explain why interpretability is a critical issue for trust and safety in clinical AI.
...
import SaliencyMapReveal from '@site/src/components/widgets/saliency-map-reveal';
...
<div style={{
  ...
  />
  <img 
    src="/img/visualdx-screenshot-4.png" 
    alt="VisualDx Screenshot 4" 
    style={{
      maxWidth: '38%',
      height: 'auto',
      borderRadius: '8px',
